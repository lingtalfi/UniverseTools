...
DependencyTool::parsePlanetDependencies
================



DependencyTool::parsePlanetDependencies — Returns the real planet dependencies by scanning the planet folder.
...
public static [DependencyTool::parsePlanetDependencies](https://github.com/lingtalfi/UniverseTools/blob/master/doc/api/Ling/UniverseTools/DependencyTool/parsePlanetDependencies.md)(string $planetDir) : array
