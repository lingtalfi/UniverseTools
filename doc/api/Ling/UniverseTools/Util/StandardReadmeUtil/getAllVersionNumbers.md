...
Source Code
===========
See the source code for method [StandardReadmeUtil::getAllVersionNumbers](https://github.com/lingtalfi/UniverseTools/blob/master/Util/StandardReadmeUtil.php#L242-L276)
