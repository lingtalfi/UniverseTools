...
Source Code
===========
See the source code for method [StandardReadmeUtil::getErrors](https://github.com/lingtalfi/UniverseTools/blob/master/Util/StandardReadmeUtil.php#L118-L121)
